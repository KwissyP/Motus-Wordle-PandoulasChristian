const dico = ['abondant','jalousie','polygame','enfileur','eluminer','prunelle', 'enfoires','feconder','deformer','deflorer']
let keys = {
    'a': '',
    'z': '',
    'e': '',
...
const SecretWord = dico[Math.floor(Math.random() * dico.length)];
